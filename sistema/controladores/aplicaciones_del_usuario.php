...
require_once $_PETICION->basePath.'/presentacion/html.php/aplicaciones_del_usuario/aplicacion_usuario_pdf.php';

require_once $_PETICION->basePath.'/modelos/Usuario.php';

require_once $_PETICION->basePath.'/modelos/app.php';

class aplicaciones_del_usuario extends Controlador{
	var $modelo="aplicacion_usuario";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Aplicacion_usuarioPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
