...
require_once $_PETICION->basePath.'/modelos/status_de_acceso.php';
require_once $_PETICION->basePath.'/presentacion/html.php/status_de_accesos/status_de_acceso_pdf.php';

class status_de_accesos extends Controlador{
	var $modelo="status_de_acceso";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Status_de_accesoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
	...
	function eliminar(){
		...
		if (empty($id) ){			
			...
			$response=array(
				'success'=>$res,
				'msg'=>'Status de Acceso Eliminado'
			);
