...
require_once $_PETICION->basePath.'/presentacion/html.php/accesos/acceso_pdf.php';
...
class accesos extends Controlador{
	var $modelo="acceso";	
		...
		function buscarStatus_de_acceso(){
			$status_de_accesoMod= new status_de_accesoModelo();
			$res = $status_de_accesoMod->buscar( array() );
			echo json_encode( $res );
		}
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new AccesoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
