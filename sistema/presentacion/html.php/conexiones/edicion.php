		...
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_db_name" style=""  >
					<label style="">Db_name:</label>
					<input title="Db_name" type="text" name="db_name" class="entradaDatos" value="<?php echo $this->datos['db_name']; ?>" style="width:500px;" />
				</div>
				...
				<div class="inputBox contenedor_fk_empresa oculto" style=""  >
					<label style="">Empresa:</label>
					<input title="Empresa" type="text" name="fk_empresa" class="entradaDatos" value="<?php echo $this->datos['fk_empresa']; ?>" style="width:500px;" />
				</div>
			</form>
