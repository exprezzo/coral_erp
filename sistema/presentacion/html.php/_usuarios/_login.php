...
?>
	...
	<div id="titulo" style=" ">
    	...
    	<div id="contenedorCalendario" style="display:none;">
			<span id="dia"><?php echo $fecha->format('d'); ?></span> <span id="mes"><?php echo $nombreMes ?></span> <span id="año" style=""><?php echo $fecha->format('Y'); ?></span>    
		</div>
	</div>
    ...
    <div id="cuerpo">
    	<div id="contenedorLogin">
            ...
            <form name="login" action="<?php echo $_PETICION->url_app.$_PETICION->modulo; ?>/usuarios/login" method="POST">
