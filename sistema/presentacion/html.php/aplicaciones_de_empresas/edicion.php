...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionAplicaciones_de_empresas();
		 editor.init(config);	
		//-----
...
<div class="contenedor_formulario" id="<?php echo $id; ?>">
	<div id="titulo">
    	<h1>Nueva Aplicacion de Empresa</h1>
	</div>
	<div id="cuerpo">
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_fk_app" style=""  >
					<a target="_blank" href="<?php echo $_PETICION->url_app.$_PETICION->modulo.'/apps/nuevo'; ?>"><label style="">App:</label></a>
				...
				<div class="inputBox contenedor_status" style=""  >
					...
					<input title="Status" type="text" name="status" class="entradaDatos" value="<?php echo $this->datos['status']; ?>" style="width:500px;" />
				</div>
			</form>
