var EdicionStatus_apps = function(){
	this.editado=false;
	this.tituloNuevo='Nuevo Estado de Aplicacion';
	this.saveAndClose=false;
	
	var me=this;
	this.borrar=function(){		
		var r=confirm("¿Eliminar Status de Aplicacion ?");
		if (r==true){
		  this.eliminar();
		}
	}
	...
	this.actualizarTitulo=function(){
		...
		if (id>0){						
			$(tabId +' #titulo h1').html('Status App: ' + getValorCampo('nomre') + ''); 
		}else{
