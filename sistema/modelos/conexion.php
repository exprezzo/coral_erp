...
class conexionModelo extends Modelo{	
	var $tabla='erp_empresa_database';
	var $pk='id';
	var $campos= array('id', 'host', 'db_name', 'user', 'pass', 'fk_empresa');
	...
	function buscar($params){
		...
		if ( !empty($params['filtros']) ){
			foreach($params['filtros'] as $filtro){
				...
				if ( $filtro['dataKey']=='fk_empresa' ) {
					$filtros .= ' conexion.fk_empresa like :fk_empresa OR ';
				}			
			}
		...
		if ($paginar){
			$limit=$params['limit'];
			$start=$params['start'];
			$sql = 'SELECT conexion.id, conexion.host, conexion.db_name, conexion.user, conexion.pass, conexion.fk_empresa FROM '.$this->tabla.' conexion '.$joins.$filtros.' limit :start,:limit';
		}else{
			$sql = 'SELECT conexion.id, conexion.host, conexion.db_name, conexion.user, conexion.pass, conexion.fk_empresa FROM '.$this->tabla.' conexion '.$joins.$filtros;
		}
	...
	function obtener( $llave ){		
		$sql = 'SELECT conexion.id, conexion.host, conexion.db_name, conexion.user, conexion.pass, conexion.fk_empresa
 FROM erp_empresa_database AS conexion
