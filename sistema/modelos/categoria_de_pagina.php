...
class categoria_de_paginaModelo extends Modelo{	
	...
	function buscar($params){
		...
		if ($paginar){
			$limit=$params['limit'];
			$start=$params['start'];
			$sql = 'SELECT categoria_de_pagina.id, categoria_de_pagina.nombre FROM '.$this->tabla.' categoria_de_pagina '.$joins.$filtros.' limit :start,:limit';
		}else{
			$sql = 'SELECT categoria_de_pagina.id, categoria_de_pagina.nombre FROM '.$this->tabla.' categoria_de_pagina '.$joins.$filtros;
		}
	...
	function obtener( $llave ){		
		$sql = 'SELECT categoria_de_pagina.id, categoria_de_pagina.nombre
