...
{ dataKey: "foto", visible:true, headerText: "Foto" },
{ dataKey: "fecha", visible:true, headerText: "Fecha" },
{ dataKey: "peso", visible:true, headerText: "Peso" },
{ dataKey: "codigo_fk_camada", visible:true, headerText: "Camada" },
{ dataKey: "fk_camada", visible:false, headerText: "Camada" },
{ dataKey: "nombre_fk_sexo", visible:true, headerText: "Genero" },
{ dataKey: "fk_sexo", visible:false, headerText: "Genero" },
{ dataKey: "codigo", visible:true, headerText: "Serie" },
			]
		});
