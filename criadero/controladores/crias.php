...
require_once $_PETICION->basePath.'/modelos/cria.php';
require_once $_PETICION->basePath.'/presentacion/html.php/crias/cria_pdf.php';

require_once $_PETICION->basePath.'/modelos/.php';

require_once $_PETICION->basePath.'/modelos/genero.php';

class crias extends Controlador{
	var $modelo="cria";	
		...
		function buscarGenero(){
			$generoMod= new generoModelo();
			$res = $generoMod->buscar( array() );
			echo json_encode( $res );
		}
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new CriaPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
