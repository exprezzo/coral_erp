...
require_once $_PETICION->basePath.'/modelos/camada.php';
require_once $_PETICION->basePath.'/presentacion/html.php/camadas/camada_pdf.php';

class camadas extends Controlador{
	var $modelo="camada";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new CamadaPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
