...
<link href="<?php echo $url_web_presentacion; ?>libs/Gritter-master/css/jquery.gritter.css" rel="stylesheet" type="text/css" />
		...
		<script src="<?php echo $url_web_presentacion; ?>js/catalogos/usuarios/login.js" type="text/javascript"></script>
		<!--fonts-->

		<link rel="stylesheet" href="<?php echo $url_web_presentacion; ?>http://fonts.googleapis.com/css?family=Open+Sans:400,300" />
	...
	<body class="login-layout">
					...
					<div class="span12">
						<div class="login-container">
							<div class="row-fluid">
								<div class="center">
									<h1>
										<i class=" green" style="width: 32px; height: 35px; vertical-align:bottom; background-repeat:no-repeat; display: inline-block; background-image:url(<?php echo $url_web_presentacion; ?>/imagenes/logo_coral.png) !important;" ></i>
									...
									<div id="forgot-box" class="forgot-box widget-box no-border">
										<div class="widget-body">
											...
											<div class="toolbar center">
												<a href="<?php echo $url_web_presentacion; ?>#" onclick="show_box('login-box'); return false;" class="back-to-login-link">
													Volver al Login
												...
												<form id="frmRegistro" />
													<fieldset>
														...
														<label>
															...
															<span class="lbl">
																Acepto
																<a href="<?php echo $url_web_presentacion; ?>#">Licencia</a>
															</span>
														</label>
		...
		<script src="<?php echo $url_web_presentacion; ?>http://ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>

		<!--<![endif]-->

		<!--[if IE]>
<script src="<?php echo $url_web_presentacion; ?>http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<![endif]-->
