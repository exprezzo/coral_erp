...
-- ----------------------------
-- Table structure for `constructor_catalogos`
-- ----------------------------
DROP TABLE IF EXISTS `constructor_catalogos`;
CREATE TABLE `constructor_catalogos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of constructor_catalogos
-- ----------------------------
INSERT INTO `constructor_catalogos` VALUES ('18', '8', 'Usuarios', 'usuarios', 'Usuario', 'system_usuarios', 'id', 'http://png.findicons.com/files/icons/1620/crystal_project/64/personal.png', 'Nuevo Usuario', 'Usuario: {nombre}', 'Buscar Usuario', 'Usuario Creado', 'Usuario Actualizado', '¿Eliminar Usuario?', '', '', 'nick, email, name');
INSERT INTO `constructor_catalogos` VALUES ('32', '2', 'Modulos', 'modulos', 'modulo', 'system_modulos', 'id', 'http://png.findicons.com/files/icons/1681/siena/48/puzzle_yellow.png', 'Nuevo Modulo', '\'Modulo: \' + getValorCampo(\'nombre\')', 'Modulos', 'Modulo Creado', 'Modulo Actualizado', '¿Eliminar Modulo?', '', '', '');
INSERT INTO `constructor_catalogos` VALUES ('33', '2', 'Catalogos', 'catalogos', 'Catalogo', 'system_catalogos', 'id', 'http://png.findicons.com/files/icons/577/refresh_cl/48/windows_view_icon.png', 'Nuevo Catalogo', '\'Catalogo: \' + getValorCampo(\'nombre\')', '\'Buscar Catalogos\'', 'Catalogo Creado', 'Catalogo Actualizado', 'Eliminar Catalogo', 'Catalogo Eliminado', 'Ha hecho cambios en el catalogo,ï¿½Guardar antes de salir?', 'nombre');
INSERT INTO `constructor_catalogos` VALUES ('40', '8', 'Paginas', 'paginas', 'pagina', 'system_pagina', 'id', 'default.png', 'Nueva Pagina', 'Pagina:  {titulo}', 'Buscar Paginas', 'Pagina Creada', 'Pagina Actualizada', '¿Eliminar Pagina?', 'Pagina Eliminada', 'Desea Guardar los cambios', 'nombre');
INSERT INTO `constructor_catalogos` VALUES ('41', '2', 'Elemento del Catalogo', 'elementos', 'elemento', 'constructor_elemento_catalogo', 'id', '', 'Nuevo Elemento', '\'Editar Elemento\'', 'Buscar Elemento', 'Elemento Creado', 'Elemento Actualizado', 'Â¿Eliminar Elemento?', 'Elemento Eliminado', 'Â¿Guardar Cambios del Elemento?', 'Field, componente');
INSERT INTO `constructor_catalogos` VALUES ('94', '8', 'Aplicaciones', 'apps', 'app', 'constructor_app', 'id', '', 'Nueva App', 'Aplicacion: {nombre}', 'Aplicaciones', 'Aplicacion Creada', 'Aplicacion Actualizada', '¿Eliminar Aplicacion?', 'Aplicacion Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('108', '8', 'Categoria de Pagina', 'categorias_de_pagina', 'categoria_de_pagina', 'system_categoria_pagina', 'id', '', 'Nueva Categoria de Pagina', 'Categoria de Pagina: {nombre}', 'Buscar Categorias de Pagina', 'Categoria de Pagina Creada', 'Categoria de Pagina Actualizada', 'Â¿Eliminar Categoria de Pagina?', 'Categoria de Pagina Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('109', '8', 'Menu', 'menus', 'menu', 'system_menu', 'id', '', 'Nuevo Menu', 'Menu: {titulo}', 'Menus', 'Menu Creado', 'Menu Actualizado', '¿Eliminar Menu?', 'Menu Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('111', '8', 'Paises', 'paises', 'pais', 'system_ubicacion_paises', 'id', '', 'Nuevo País', 'País: {nombre}', 'Paises', 'País Creado', 'País Actualizado', '¿Actualizar País?', 'País Elimindo', '', '');
INSERT INTO `constructor_catalogos` VALUES ('112', '8', 'Estados', 'estados', 'estado', 'system_ubicacion_estados', 'id', '', 'Nuevo Estado', 'Estado: {nombre}', 'Estados', 'Estado Creado', '¿Actualizar Estado?', '¿Eliminar Estado?', 'Estado Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('113', '8', 'Municipios', 'municipios', 'municipio', 'system_ubicacion_municipios', 'id', '', 'Nuevo Municipio', 'Municipio: {nombre}', 'Municipios', 'Municipio Creado', 'Municipio Actualizado', '¿Eliminar Municipio?', 'Municipio Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('114', '8', 'Empresas', 'empresas', 'empresa', 'erp_empresa', 'id', '', 'Nueva Empresa', 'Empresa: {nombre}', 'Empresas', 'Empresa Creada', 'Empresa Actualizada', '¿Eliminar Empresa?', 'Empresa Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('115', '8', 'Conexiones', 'conexiones', 'conexion', 'erp_empresa_database', 'id', '', 'Nueva Conexion', 'Conexion: {host}', 'Conexiones', 'Conexion Creada', 'Conexion Actualizada', '¿Eliminar Conexion?', 'Conexion Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('116', '8', 'Rol', 'roles', 'rol', 'system_rol', 'id', '', 'Nuevo Rol', 'Rol: {nombre}', 'Roles', 'Rol Creado', 'Rol Actualizado', '¿Eliminar Rol?', 'Rol Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('117', '8', 'Accesos a Empresa', 'accesos', 'acceso', 'erp_usuario_empresa', 'id', '', 'Nuevo Acceso', 'Acceso: {id}', 'Accesos', 'Nuevo Acceso', 'Acceso Actualizado', '¿Eliminar Acceso?', 'Acceso Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('118', '8', 'Status Del Acceso', 'status_de_accesos', 'status_de_acceso', 'erp_acceso_status', 'id', '', 'Nuevo Status de Acceso', 'Status de Acceso: {nombre}', 'Status de Acceso', 'Status de Acceso Creado', 'Status de Acceso Actualizado', '¿Eliminar Status de Acceso?', 'Status de Acceso Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('119', '8', 'Status de la aplicacion', 'status_apps', 'status_app', 'erp_empresa_aplicacion_status', 'id', '', 'Nuevo Estado de Aplicacion', 'Status App: {nomre}', 'Status de Aplicacion', 'Status de Aplicacion Creado', 'Status de Aplicacion  Actualizado', '¿Eliminar Status de Aplicacion ?', 'Status de Aplicacion  Eliminado', '', '');
INSERT INTO `constructor_catalogos` VALUES ('120', '8', 'Aplicaciones de La Empresa', 'aplicaciones_de_empresas', 'aplicacion_empresa', 'erp_empresa_app', 'id', '', 'Nueva Aplicacion de Empresa', 'Aplicacion de Empresa: {id}', 'Aplicaciones de Empresas', 'Aplicacion de Empresa Creada', 'Aplicacion de Empresa Actualizada', '¿Eliminar Aplicacion de Empresa?', 'Aplicacion de Empresa Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('121', '9', 'Unidades De Medida', 'unidades_de_medida', 'unidad_de_medida', 'ventas_um', 'id', '', 'Nueva  Unidad de Medida', 'Unidad de Medida: {nombre}', 'Unidades de Medida', 'Unidad de Medida Creada', 'Unidad de Medida Actualizada', 'Â¿Eliminar Unidad de Medida ?', 'Unidad de Medida Eliminada', '', '');
INSERT INTO `constructor_catalogos` VALUES ('122', '22', '', '', '', '', '', '', '', '', '', '', '', '', '', '', null);

-- ----------------------------
-- Table structure for `constructor_catalogo_elemento`
-- ----------------------------
DROP TABLE IF EXISTS `constructor_catalogo_elemento`;
CREATE TABLE `constructor_catalogo_elemento` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `extras` char(255) DEFAULT NULL,
  `campo` char(255) DEFAULT NULL,
  `llave` char(255) DEFAULT NULL,
  `esNulo` char(255) DEFAULT NULL,
  `fk_componente` int(255) DEFAULT NULL,
  `comp_config` text,
  `fk_catalogo` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_catalogo` (`fk_catalogo`),
  CONSTRAINT `constructor_catalogo_elemento_ibfk_1` FOREIGN KEY (`fk_catalogo`) REFERENCES `system_catalogos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1190 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of constructor_catalogo_elemento
-- ----------------------------
INSERT INTO `constructor_catalogo_elemento` VALUES ('1189', '', '', '', '', '0', '', '122');

-- ----------------------------
-- Table structure for `constructor_componente`
-- ----------------------------
DROP TABLE IF EXISTS `constructor_componente`;
CREATE TABLE `constructor_componente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` char(255) DEFAULT NULL,
  `descripcion` char(255) DEFAULT NULL,
  `preview` char(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of constructor_componente
-- ----------------------------
INSERT INTO `constructor_componente` VALUES ('1', 'Text Input', null, null);
INSERT INTO `constructor_componente` VALUES ('2', 'Date Input', '', '');
INSERT INTO `constructor_componente` VALUES ('3', 'Image Input', '', '');
INSERT INTO `constructor_componente` VALUES ('4', 'File Input', '', '');
INSERT INTO `constructor_componente` VALUES ('5', 'Combo Box', '', '');
INSERT INTO `constructor_componente` VALUES ('6', 'Tabla', '', '');
INSERT INTO `constructor_componente` VALUES ('7', 'CheckBox', '', '');
INSERT INTO `constructor_componente` VALUES ('8', 'Number Input', '', '');
