...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionComponentes();
		 editor.init(config);	
		//-----
	...
	<div id="cuerpo">
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_preview" style=""  >
					<label style="">Preview:</label>
					<input title="Preview" type="text" name="preview" class="entradaDatos" value="<?php echo $this->datos['preview']; ?>" style="width:500px;" />
				</div>
			</form>
