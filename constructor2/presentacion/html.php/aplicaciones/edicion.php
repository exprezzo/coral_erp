...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionAplicaciones();
		 editor.init(config);	
		//-----
		...
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_nombre_interno" style=""  >
					...
					<input title="Nombre_interno" type="text" name="nombre_interno" class="entradaDatos" value="<?php echo $this->datos['nombre_interno']; ?>" style="width:500px;" />
				</div>
			</form>
