...
require_once $_PETICION->basePath.'/presentacion/html.php/componentes/conmponente_pdf.php';

class componentes extends Controlador{
	var $modelo="conmponente";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new ConmponentePdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
