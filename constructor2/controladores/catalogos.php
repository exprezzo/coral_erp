...
require_once $_PETICION->basePath.'/presentacion/html.php/catalogos/catalogo_pdf.php';
...
class catalogos extends Controlador{
	var $modelo="catalogo";	
		...
		function buscarAplicacion(){
			$aplicacionMod= new aplicacionModelo();
			$res = $aplicacionMod->buscar( array() );
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new CatalogoPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
