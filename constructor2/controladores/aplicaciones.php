...
require_once $_PETICION->basePath.'/modelos/aplicacion.php';
require_once $_PETICION->basePath.'/presentacion/html.php/aplicaciones/aplicacion_pdf.php';

class aplicaciones extends Controlador{
	var $modelo="aplicacion";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new AplicacionPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
