...
-- ----------------------------
-- Table structure for erp_acceso_status
-- ----------------------------
DROP TABLE IF EXISTS `erp_acceso_status`;
CREATE TABLE `erp_acceso_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of erp_acceso_status
-- ----------------------------
INSERT INTO `erp_acceso_status` VALUES ('1', 'Activo', '');
INSERT INTO `erp_acceso_status` VALUES ('2', 'Suspendido', '');
...
-- ----------------------------
DROP TABLE IF EXISTS `erp_empresa_aplicacion_status`;
CREATE TABLE `erp_empresa_aplicacion_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(255) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Records of erp_empresa_aplicacion_status
-- ----------------------------

-- ----------------------------
-- Table structure for erp_empresa_app
-- ----------------------------
DROP TABLE IF EXISTS `erp_empresa_app`;
CREATE TABLE `erp_empresa_app` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `erp_empresa_database`;
CREATE TABLE `erp_empresa_database` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `erp_usuario_empresa`;
CREATE TABLE `erp_usuario_empresa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
INSERT INTO `system_categoria_pagina` VALUES ('1', 'Publicas', '0');
INSERT INTO `system_categoria_pagina` VALUES ('2', 'Inicio', '0');
...
-- ----------------------------
INSERT INTO `system_pagina` VALUES ('1', 'Cerritos', '144', 'asdfas', '0', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `system_rol` VALUES ('1', 'SysAdmin', 'Es el que administra el ERP');
INSERT INTO `system_rol` VALUES ('2', 'Administrador', 'Es la persona con mayor autoridad en una empresa');
INSERT INTO `system_rol` VALUES ('3', 'Usuario', 'Es una persona con privilegios limitados');
