...
require_once $_PETICION->basePath.'/presentacion/html.php/unidades_de_medida/unidad_de_medida_pdf.php';

class unidades_de_medida extends Controlador{
	var $modelo="unidad_de_medida";	
	...
	function bajarPdf(){
		...
		//-------
		$objPdf = new Unidad_de_medidaPdf('P','mm','letter');
		$objPdf->datos=$datos;
		$objPdf->AddPage();
		$objPdf->imprimir(  );
		//-------
