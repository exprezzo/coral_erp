...
<script>			
	$( function(){	
		...
		var config={
		 ...
		 var editor=new EdicionUnidades_de_medida();
		 editor.init(config);	
		//-----
		...
		<div id="contenedorDatos2">
			<form class="frmEdicion" style="">
				...
				<div class="inputBox contenedor_abreviacion" style=""  >
					...
					<input title="Abreviacion" type="text" name="abreviacion" class="entradaDatos" value="<?php echo $this->datos['abreviacion']; ?>" style="width:500px;" />
				</div>
			</form>
